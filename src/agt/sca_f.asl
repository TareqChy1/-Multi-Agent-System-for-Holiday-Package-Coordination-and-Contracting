// Service Company Agent with a Fixed service
// This is to make sure the service is offered by at least one person
...
my_price("Transport", 80). // minimum profit for these tasks
my_price("Accommodation", 100).
my_price("Tours", 90).
